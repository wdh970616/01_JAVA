...
public class Application1 {
    public static void main(String[] args) {
         ...
         * -> 클래스명은 사실 패키지명을 포함하고 있기 때문
         * 예) com.ohgiraffers.section02.package_and_import.Application1
         * 서로 다른 패키지에 존재하는 클래스를 사용하는 경우에는 클래스명 앞에 패키지명을 명시해서 풀 클래스 이름으로 사용해야한다.
         */
        ...
        System.out.println("다른 패키지에서 매소드 호출 (최대값) : " + max);
    }
}
