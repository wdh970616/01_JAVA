...
public class UserDTO {
     ...
     *
     * 지금은 특정 목적에 따라 클래스를 작성하는 규칙이라고 보면됨.
     */
     ...
     * 4. 모든 멤버 변수에 접근 가능한 설정자와 접근자가 public으로 작성되어있어야함.
    ...
    // 매개변수 있는 생성자는 선택사항
    // 매개변수 있는 생성자 중 가장 많이 사용되는것은 모든 필드를 초기화 하는 생성자이다.
    // alt + insert 의 construtor로 생성자 한번에 생성 가능
    ...
    public String getInfo() {
        return "'" + this.name + "'님의 정보 [id : " + this.id + " | pwd : " + this.pwd + " | 생성일자 : " + this.enrollDate + "]";
    }
}
