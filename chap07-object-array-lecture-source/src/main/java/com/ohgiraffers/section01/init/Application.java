...
public class Application {
    public static void main(String[] args) {
         ...
         * 객체배열
         *
         * 객체배열은 래퍼런스변수에 대한 배열이다.
         * 생셩한 인스턴스도 배열을 이용해서 관리하면 동일한타입의 여러개 인스턴스를 각각 취급하지않고 연속처리 할수있어서 좋다.
         * 또한 반환값은 1개의 값만 반환할 수 있기 때문에 동일 타입의 여러 인스턴스를 반환해야하는 경우 객체배열을 이용할 수 있다.
         */

        Car car1 = new Car("페라리", 300);
        Car car2 = new Car("람보르기니", 350);
        Car car3 = new Car("롤스로이스", 400);
        Car car4 = new Car("부가티베이론", 450);
